                    ...
                    <div className="lg:w-[320px]">
                        <FadeUp>
                            <h2 className="font-geist text-4xl font-semibold">
                                Meet the Innovators Behind the System
                            </h2>

                            <p className="mt-5 leading-7 font-light text-primary-black">
                                Built by passionate Innovators focused on solving real parking challenges through intelligent automation, IoT technology, and data-driven design.
                            </p>
                    ...
                    <FadeUp>
                        <div className="rounded-3xl bg-bg-subtle p-8">
                            <div className="flex items-center gap-3">
                                <HugeiconsIcon icon={AddTeamIcon} size={30} />
                            ...
                            <p className="mt-4 max-w-125.5 font-light text-primary-black">
